...
class Patient(BaseModel):
    ...
    married: bool                       # Must be a bool
    allergies: List[str]                # Must be a list of text values
...
# Raw Dictionary
patients_info = {"name": "Sam", "age": "20", "married": True, "allergies": ["pollen", "dust", "gluten"], "contact_details": {"email": "abc@email.com", "phone": "123"}}
