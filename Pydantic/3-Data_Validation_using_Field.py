...
class Patient(BaseModel):
    name: str = Field(max_length=50, description="Name of the patient")                    # Must be a text
    age: int = Field(gt=0, le=120, description="Age of the patient in years")                      # Must be an int
    linkedin_url: AnyUrl
    married: Optional[bool]  = None                     # Must be a bool
    allergies: Optional[List[str]] = Field(max_length=5) # Must be a list of text values
